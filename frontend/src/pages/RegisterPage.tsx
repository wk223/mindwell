    ...
    <div className="min-h-screen flex items-center justify-center bg-void-950 px-4 relative">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-slate-500 mt-2 text-sm">开启你的心灵疗愈之旅</p>
        </div>
        ...
        >
          <h2 className="font-serif text-xl font-medium text-slate-200 mb-6">注册</h2>

          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              <label htmlFor="nickname" className="block text-sm font-medium text-slate-400 mb-1.5">
                昵称
              </label>
              <input
                id="nickname"
          ...
          <p className="text-center text-sm text-slate-600 mt-6">
            已有账号？{" "}
            <Link to="/login" className="text-moon-400 hover:text-moon-300 font-medium transition-colors">
              登录
            </Link>
          </p>
        </div>
